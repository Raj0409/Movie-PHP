...
<br>
<?php
echo "<a href='delete.php' class='backlink'>Back</a>";
...
while ($avgrow=mysqli_fetch_array($avgres))
{
	...
	if($mid==$avgrow['mid'])
	{
		echo "<img src='img/s1.png' height='40px' width='40px' >
				<div style='padding:4px'>$arr[$count]</div>";
	}
	$count++;
}
?>
...
{	
	...
	{
	?>
	<a href='deleteMovie.php?mid=<?php echo $mid;?>' class='review' onclick="return confirm('Are you sure you want to delete this movie?')">Delete Movie</a>
	<?php		
	}
}
?>
...
<div class="maindiv">
	<div class="imgdiv">
		<img src="img/user.png" class="imgface" height="120px" width="120px"/>
	</div>
	...
	<div class="contentdiv">
		...
		?>
		<p class="commentClass"><?php echo $row[3];?></p>
		<a href="deleteReview.php?mid=<?php echo $mid?>&uid=<?php echo $uid?>" class="btnSubmit">Delete Review</a>
	</div>
</div>
<br>
<hr>
